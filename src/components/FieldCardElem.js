        ...
        <div>
            <Card style={{ width: '20rem' }} className="league_card">
                <a onClick={handleShow} className="modal-link">
                    <Card.Img variant="top" src={require(`../images/${props.img}`)} alt="Field picture" className="league_card--image" />                
                        ...
                        <div className="row g-0">
                            <div className="col-8">
                                <div className="modal-img-container">
                                    <img src={require(`../images/${props.img}`)} alt="Field picture" className="field-modal--img" />
                                </div>
                            </div>
                            <div className="col-4">
                                <div className="row g-1 icons">
                                    ...
                                    <div className="col-9 field-icon-desc-col">
